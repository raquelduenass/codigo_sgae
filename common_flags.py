...
# Files
gflags.DEFINE_string('experiment_root_directory', "./models/test_30", 'Folder '
...
gflags.DEFINE_bool('restore_model', False, 'Whether to restore a trained'
                   ' model for training')
gflags.DEFINE_string('weights_filename', './models/test_30/weights_040.h5',
                     '(Relative) filename of model weights')
gflags.DEFINE_string('initial_weights', './models/test_30/weights_004.h5',
