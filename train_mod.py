...
def _main():
    ...
    if FLAGS.initial_epoch == 0:
        data_utils_sgae.cross_val_create(FLAGS.data_path)
    ...
    train_datagen = data_utils_sgae.DataGenerator(rescale = 1./255)
    ...
    val_datagen = data_utils_sgae.DataGenerator(rescale = 1./255)
